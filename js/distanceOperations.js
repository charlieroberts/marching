...
const ops = { 
  ...
  ColumnsUnion(  ...args ) { return `fOpUnionColumns( ${args.join(',')} )`  },
  ColumnsIntersection( ...args ) { return `fOpIntersectionColumns( ${args.join(',')} )` },
  ColumnsDifference( ...args ) { return `fOpDifferenceColumns( ${args.join(',')} )` },
